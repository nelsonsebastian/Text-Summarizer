        ...
        <div class="container ">
			...
			<div class="row h-100 align-items-center text-center">
				 <div class="col-md-12">
					...
					<form method="POST" enctype="multipart/form-data">
						 <div class="col-md-12">Upload Pdf</div>
						 <center><div class="col-md-8">	
							<input type="file"  name="f1" class='form-control' accept=".pdf" required/></center>
						<br><button type="submit" class="btn btn-primary btn-lg" name="submit">Submit<br></button><br><br>	
					</form>
				</div>
			</div>
			<?php
			...
			if(isset($_POST['submit'])) {
				...
				// Check if a file was uploaded and if there are no errors
					move_uploaded_file($_FILES['f1']['tmp_name'],"test.pdf");
				
				

				$python = `python pdf_txt.py`;


				$python1 = `python test_bert.py`;
					
				echo"<div class='well' style='background-color:#f3f3f3;padding:10px;border-radius:10px;'>";
				echo"<h3>OUTPUT SUMMARY</h3><br>$python1";
				echo"</div>";	
